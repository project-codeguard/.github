...
[Project CodeGuard](https://github.com/cosai-oasis/project-codeguard) solves this by embedding security best practices directly into AI coding agent workflows. It supports agent skills and rules that can be used in most coding agent platforms to make this happen.
